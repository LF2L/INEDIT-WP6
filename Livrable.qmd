...
![Initial recovered workbench](figures/demos/workbench/Initial.jpg){#fig-demo2.1 height=1in }

![Refurbished workbench](figures/demos/workbench/Final.jpeg){#fig-demo2.2 height=1in}
...
:::{#fig-desk-final layout="[[2,1]]"}
![Final assembling of the desk ](figures/demos/desk/desk-04.jpg){#fig-desk-04 width=300}
...
In that frame, we have the possibility of the experimentation with the local association of designers called **L’A.Paillette** at Octroi reagarding the design and build 3 mobile and movable modules to establish a kitchen corner for the association. 
