...
1) desktop injection moulding process (small and medium sizes), 
...
Gigabot X XL machine extruder has a long barrel with 3 heating elements or zone which helps in the melting of the thermoplastic. 
...
An exchange with key actors in territorial development was necessary in order to achieve this task.   
...
Local ecosystem interviewed about the implementation ofa 3D printing recycled demostrator
:::
...
The first proposition was made in the @fig-apa-00.

![Sketch models proposed by the local actor L'A.Paillette](figures/demos/apa/Modeles-Furniture-00.jpg){#fig-apa-00 width = 90%}
