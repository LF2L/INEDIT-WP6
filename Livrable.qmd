...
![Test of printability](figures/Swapnil-Results-01.jpg){#fig-printability1 width=90%}

![Validation of the printability](figures/Swapnil-Results-02.jpg){#fig-printability2 width=90%}
...
###  Personilzation of existing furniture
...
Using the case of a personalization of a commericla furniture-arranging tool as displayed in @fig-demo1, several printed parts were manufactured to evaluate the technical pertinence of the reults as part a existing furniture.
...
Therefore, the idea was to use  the scanner option and the sketch feature of the  DesignTogether tool developed by the colleges of ENSAM / TTPS, with the manufacturing tools at the green fablab.

First, once the workbench was dismantled, it was scanned using the an IPad Pro according to the technical characteristics needed for the application.
Then, the model was upload in the DesignTogether application in order to make a brainstorming ideas of features that are neccesary to consider for the refurbishing. 

:::{#fig-demo2 layout="[[1,1], [1]]"}
...
Afterwards, this model enables a firs materialization of the of the proposition that could be made. So, the different manual task started in function


### Connecting the Recycling part and the Smartification

Connecting the Uninova

In this third experimentation, we connected the process of the Smartification process in the frame of the ICE-IAMOT conference demostrator.
