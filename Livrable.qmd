...
![Deployment of the Smart Collectors.](figures/SC/Deployment.jpg){#fig-sc-deployment width=700}
...
![Photo of the sorting process](figures/sorting/sorting.jpg){width=60%}
