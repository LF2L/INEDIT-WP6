...
Using the software for the , we are in measure to validate the global dimmensions of the proposed part.
...
Concerning the printability, based on the characteristics of the material and the variables of the machine (namely, the temperatures of the barrel, the rotation of the stepper motors and the diamter of the nozzle).
...
![Test of printability](figures/Results-00.jpg){#fig-printability1 width=90%}

![Validation of the printability](figures/Swapnil-Results-00.png){#fig-printability2 width=90%}

Experimental protocol to validate the printability tests.

:::

The test of printability consist in the selection the technical parameters of the machine ()
Using a Design of Experiments (DoE) approach, and a basic benchmarking models (for instance lines, cubes, pyramides in @fig-printability2), it is possible to identify the errors in the printing process.
<!-- conclusion -->
...
::: { layout="[[1,2]]"}
In this experimentation the purpose was to validate the possibility of the 

![Personlizing a existing furniture](figures/Demo-01.png){width=90%}
:::
...
![Photo of the Slicer of the Gigzbot](figures/Image-to-add.png){width=100%}
