...
\ganttgroup[name=T4, progress=10 ]{\color{blue}T6.4 3D printing of recycled plastic demonstrator}{2021-03}{2022-07}\\ 
   ...
   \ganttbar[name=T4_1, progress=50]{Coordination and alignement with WP 4.3-4.4 tasks}{2021-03}{2021-09} \\
   
   \ganttbar[name=T4_2, progress=95 ]{Literature and Background on Additive manufacturing / Recycling / Sustainability}{2021-03}{2021-07}\\ 
