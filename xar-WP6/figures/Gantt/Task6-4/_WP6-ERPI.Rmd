---
title: "Planning WP6 - T6.4 3D printing of recycled plastic demonstrator"
#output: html_document
#classoption: landscape
geometry:  margin=0.2in, paperheight=11in, paperwidth=20in
header-includes:
  - \usepackage{pgfgantt}
  - \usepackage{textcomp}
...
\begin{ganttchart}[vgrid, hgrid, 
   ...
   bar/.append style={fill=blue!50, rounded corners=3pt},
	...
	milestone label font=\color{blue} ]{2020-10-01}{2021-10-01}
	\gantttitlecalendar{year, month=shortname, week=1} \\

\ganttgroup[progress=5]{Smart Collector}{2020-10-01}{2021-07-29} \\ 

\ganttgroup{First Prototype}{2020-10-01}{2020-12-18} \\
