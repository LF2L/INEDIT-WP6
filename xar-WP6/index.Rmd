...
- .yellow[Create a V1.1 of the collector.]
- Printability test for fused granular Fabrication

**What are the next steps:**

- .yellow[Create a dashboard for smart collectors]
...
- .yellow[Printability test for fused granular Fabrication]

**What are the next steps:**

- Create a dashboard for smart collectors
- .yellow[Printability test from recycled PLA] 
