...
Planning <- magick::image_read_pdf("figures/Gantt/WP6/_Planning.pdf",
                       pages = 1)
Planning
magick::image_write(Planning, 
                    path = paste0("figures/Gantt/WP6/",Sys.Date(), "-Planning.jpg"), format = "jpg")
```
...
# Our demostrator {#GF-demostrator}
