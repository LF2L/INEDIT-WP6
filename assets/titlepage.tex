...
\begin{tabu} to 0.9\linewidth { X  X | X | X }
\toprule
...
\multicolumn{2}{l |}{ \multirow{4}{*}{  \includegraphics[width=7cm]{figures/Inedit_horiz.pdf} } }  & Work Package: & 6   \\ \cmidrule{3-4}
   ...
   & & Actual Delivery Date:    & March xx / 2023       \\ \midrule
...
\multicolumn{4}{l|}{ } \\ \midrule
 ...
 Description:    &    \multicolumn{3}{| l}{ Description of the conceptual framework of distributed recycling }   \\ 
 &    \multicolumn{3}{| l}{via additive manufacturing (DRAM) and its concrete implemnetation in a DIT approach. }   \\ 
    &    \multicolumn{3}{| l}{The technologies, materials and methods are reported}   \\
    &    \multicolumn{3}{| l}{Sevearal illustrative case studies are presented }   \\ \midrule

 Version    &   \multicolumn{3}{|l}{ Version 2}    \\ \midrule
 Contributors       & Versions    & Dates       & Revision Description \\ \midrule
WP6 Leader & 0 & February 04/2023 & Validation of the global structure  \\ \midrule        
UL & 1 & March 03/2022 & Revision of a version 1 \\ \midrule
