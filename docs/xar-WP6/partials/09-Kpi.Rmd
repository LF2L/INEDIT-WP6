...
1. .large.bg-yellow[**Validation Demonstrator for INEDIT stakeholders (according KPI's)**]
      ]   


### Main Goal:

- Validation and evaluation of the depostrator for INEDIT and establish future developments


---
class: middle
## Validation Demonstrator for INEDIT stakeholders (according KPI's?)
